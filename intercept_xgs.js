...
(async () => {
    ...
    try {
        ...
        await page.goto('https://xgs0t7.com/game/category/ELECTRONIC/23?pid=3708690480&_ts===gMyUCMxMTO0kzNzEjM3cTMyITJ', { waitUntil: 'networkidle2' });
        console.log("Done waiting.");
    } catch (e) {
        console.log("Error loading page:", e);
    }

    fs.writeFileSync('/tmp/xgs_apis.json', JSON.stringify(apisCalled, null, 2));
    await browser.close();
})();
